...
for j=1:length(f_vec) % loop over each frequency to be tested
    ...
    s_read = serial('COM18','BaudRate',115200);
...
save('MAE170_lab4_part3','f_vec','transfer_vec');
% save frequency and gain to mat file
csvwrite('MAE170_lab4part3.csv',[f_vec',transfer_vec]);
% save frequency and gain to csv file
saveas(gcf,'MAE170_lab4part3');
% save figure
